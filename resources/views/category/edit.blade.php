<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">{{ __('Edit a Category') }}</h2>
    </x-slot>
                    ...
                    <form action="{{ route('category.update', $category->slug) }}" method="post">
                        ...
                        <div class="mb-3 mt-5">
                            ...
                            <x-text-input id="name"
                                ...
                                type="text" name="name" :value="old('name', $category->name)" autofocus />
